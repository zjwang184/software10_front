                ...
                <div class="paramBox" v-if="editableTabsValue === 'dqn'">
                  ...
                  >
                    <el-form-item prop="reward">
                      <template slot="label">
                        <span class="paramTitle" style="margin:auto;">预测任务上的奖励</span>
  ...
  methods: {
    ...
    submit(url) {
      ...
      for (var target in this.m_target_features){
        ...
        console.log("this.m_target_features[target]:",this.m_target_features[target].riskFactor);
      }
