  ...
  <div>
    <div class="topStatistic">
      <el-card class="top_statistic_card">
        ...
        <el-card style="border-radius: 30px;">
          <i class="el-icon-coin" style="font-size:48px;"></i>
          样本总量 &nbsp;&nbsp;&nbsp;&nbsp; 13124
        </el-card>
        <el-card style="border-radius: 30px;">
          <i class="el-icon-time" style="font-size:48px;"></i>
          时间  &nbsp;&nbsp;&nbsp;&nbsp; 2024/3/27
        </el-card>
        <el-card style="border-radius: 30px;">
          <i class="el-icon-edit-outline" style="font-size:48px;"></i>
          任务总数   &nbsp;&nbsp;&nbsp;&nbsp; <span font-size="33px">8</span>
        ...
        <el-card>
          <div slot="header" class="clearfix">
            ...
            <!-- <el-select class="chartSelect" v-model="charttype" placeholder="请选择" size="mini" @change="changeChart">
              ...
              <el-date-picker class="chartDateSelect" v-model="value" align="right" type="date" placeholder="选择日期"
                :picker-options="pickerOptions" size="mini">
              </el-date-picker>

          </div>

          <div id="chartBox" style="height: 400px;width: 450px;">
    ...
    <div class="bottomStatistic">
      <el-card class="bottom_statistic_card">
        ...
        <el-card>
          ...
          <div id="chartBox">
            <Bar style="height: 400px;width:470px;">
            </Bar>
          </div>
        </el-card>
      </el-card>
